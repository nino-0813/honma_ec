...
const AmbassadorProductDetail = () => {
  ...
  useEffect(() => {
    ...
    // データベース接続なしでも表示できるように、常にデフォルトデータを使用
  ...
  if (!loading && error) {
    return (
      <div className="h-screen flex items-center justify-center text-center">
        ...
        <Link to="/collections">
          <a className="text-primary hover:underline">一覧に戻る</a>
        </Link>
      </div>
    );
  }
    ...
    <div className="pt-32 pb-24 bg-white min-h-screen animate-fade-in overflow-x-hidden w-full">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-[10px] text-gray-400 mb-8 md:mb-12 tracking-widest uppercase">
          ...
          <Link to="/ambassador">
            <a className="hover:text-black transition-colors">JOIN US</a>
          </Link>
          <span className="mx-2">/</span>
          ...
          <div className="lg:col-span-5">
            <div className="lg:sticky lg:top-32">
              ...
              <div className="mt-8 text-center">
                <Link to="/contact">
                  <a className="inline-block bg-black text-white px-8 py-3 text-sm tracking-widest hover:bg-gray-800 transition-colors uppercase">
                    お問い合わせ
                  </a>
                </Link>
              </div>
