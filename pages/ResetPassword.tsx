 ...
 * ローカル: http://localhost:3009/account/reset-password
 * を追加してください。
 */
const ResetPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => navigate('/mypage', { replace: true }), 2000);
    } catch (err: any) {
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            {checking ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="new-password-confirm" className="block text-sm font-medium text-gray-700 mb-2">
                    新しいパスワード（確認）
                  </label>
                  <div className="relative">
                    <IconLock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
